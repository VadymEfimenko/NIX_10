...
import ua.com.alevel.view.dto.request.util.PageAndSizeData;
import ua.com.alevel.view.dto.request.util.SortData;
...
public final class WebRequestUtil {
    ...
    public static final String MUSICIAN_PARAM = "musician";
    public static final String SEARCH_RELEASE_PARAM = "searchRelease";
