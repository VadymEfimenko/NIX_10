...
public class ProductController extends BaseController {
    ...
    private final HeaderName[] columnNames = new HeaderName[]{
            ...
            new HeaderName("product name", "productName", "productName"),
            new HeaderName("product price", "productPrice", "productPrice"),
    ...
    @GetMapping("/new")
    public String redirectToNewProductPage(Model model, WebRequest request) {
        model.addAttribute("product", new ProductRequestDto());
        model.addAttribute("customer", customerFacade.findAll(request));
    ...
    public String findById(@PathVariable Long id, Model model) {
        ...
        model.addAttribute("customers", customerFacade.findAllByProductId(id));
