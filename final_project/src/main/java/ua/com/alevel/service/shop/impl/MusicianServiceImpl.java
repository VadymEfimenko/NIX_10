...
public class MusicianServiceImpl implements MusicianService {
    ...
    public MusicianServiceImpl(CrudRepositoryHelper<Musician, MusicianRepository> crudRepositoryHelper, MusicianRepository musicianRepository, ReleaseService releaseService) {
    ...
    public void delete(Long id) {
        Set<Release> releaseSet = findById(id).get().getReleases();
        releaseSet.stream().forEach(release -> releaseService.delete(release.getId()));
