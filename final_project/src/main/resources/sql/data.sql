...
insert into musicians values(3, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP,true,  'pac');
insert into musicians values(4, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP,true,  'dan');
insert into musicians values(5, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP,true,  'snoop');

insert into releases values (1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP,true,  'cool', 'rap',
                             'https://www.bigdataschool.ru/wp-content/uploads/2020/07/elas0.png', 132, 123, 'born', 1990, 1);
